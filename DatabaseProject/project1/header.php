...
<nav class="navbar navbar-default" role="navigation">
   ...
   <div>
      ...
      <div class="navbar-form navbar-left" style="width : 40%">
		 ...
		 <div class="btn-group">
		   ...
		   <ul class="dropdown-menu" role="menu">
			  ...
			  <li class="divider"></li>
			  <li><a href="#" id="search_concert_artist">Search Concerts by Artists</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
		 ...
		 <li ><a href="#" id="my_concerts">My Concerts</a></li>
		 <li ><a href="#" id="my_artists">My Artists</a></li>
		 <li ><a href="#" id="my_genres">My Genres</a></li>
		 <li class="dropdown">
